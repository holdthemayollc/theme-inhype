...
class Walker_Nav_Menu_Edit_Custom extends Walker_Nav_Menu  {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
	    ...
	    if ( ! empty( $item->_invalid ) ) {
	        ...
	        $title = sprintf( wp_kses_post( __('%s (Invalid)', 'inhype' )), $item->title );
	    } elseif ( isset( $item->post_status ) && 'draft' == $item->post_status ) {
	        $classes[] = 'pending';
	        /* translators: %s: title of menu item in draft status */
	        $title = sprintf( wp_kses_post(__('%s (Pending)', 'inhype')), $item->title );
	    }
	            ...
	            <dt class="menu-item-handle">
	                ...
	                <span class="item-controls">
	                    ...
	                    <span class="item-order hide-if-js">
	                        ...
	                        ?>" class="item-move-up"><abbr title="<?php esc_attr_e('Move up', 'inhype'); ?>">&#8593;</abbr></a>
	                        |
	                        <a href="<?php
	                            echo wp_nonce_url(
	                                esc_url(add_query_arg(
	                        ...
	                        ?>" class="item-move-down"><abbr title="<?php esc_attr_e('Move down', 'inhype'); ?>">&#8595;</abbr></a>
	                    </span>
	                    <a class="item-edit" id="edit-<?php echo esc_attr($item_id); ?>" title="<?php esc_attr_e('Edit Menu Item', 'inhype'); ?>" href="<?php
	                    ...
	                    ?>"><?php esc_html_e( 'Edit Menu Item', 'inhype' ); ?></a>
	                </span>
	            </dt>
	        </dl>
	        ...
	        <div class="menu-item-settings" id="menu-item-settings-<?php echo esc_attr($item_id); ?>">
	            ...
	            <p class="description description-thin">
	                <label for="edit-menu-item-title-<?php echo esc_attr($item_id); ?>">
	                    <?php esc_html_e( 'Navigation Label', 'inhype' ); ?><br />
	                    <input type="text" id="edit-menu-item-title-<?php echo esc_attr($item_id); ?>" class="widefat edit-menu-item-title" name="menu-item-title[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr( $item->title ); ?>" />
	                </label>
	            </p>
	            <p class="description description-thin">
	                <label for="edit-menu-item-attr-title-<?php echo esc_attr($item_id); ?>">
	                    <?php esc_html_e( 'Title Attribute', 'inhype' ); ?><br />
	                    <input type="text" id="edit-menu-item-attr-title-<?php echo esc_attr($item_id); ?>" class="widefat edit-menu-item-attr-title" name="menu-item-attr-title[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr( $item->post_excerpt ); ?>" />
	                </label>
	            </p>
	            <p class="description description-thin">
	                <label for="edit-menu-item-badgetitle-<?php echo esc_attr($item_id); ?>">
	                    <?php esc_html_e( 'Badge title', 'inhype' ); ?><br />
	                    <input type="text" id="edit-menu-item-badgetitle-<?php echo esc_attr($item_id); ?>" class="widefat edit-menu-item-badgetitle" name="menu-item-badgetitle[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr( $item->badgetitle ); ?>" />
	                </label>
	            </p>
	            <p class="description description-thin">
	                <label for="edit-menu-item-badgecolor-<?php echo esc_attr($item_id); ?>">
	                    <?php esc_html_e( 'Badge color (#hex)', 'inhype' ); ?><br />
	                    <input type="text" id="edit-menu-item-badgecolor-<?php echo esc_attr($item_id); ?>" class="widefat edit-menu-item-badgecolor" name="menu-item-badgecolor[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr( $item->badgecolor ); ?>" />
	                </label>
	            </p>
	            <p class="field-link-target description">
	                <label for="edit-menu-item-target-<?php echo esc_attr($item_id); ?>">
	                    <input type="checkbox" id="edit-menu-item-target-<?php echo esc_attr($item_id); ?>" value="_blank" name="menu-item-target[<?php echo esc_attr($item_id); ?>]"<?php checked( $item->target, '_blank' ); ?> />
	                    <?php esc_html_e( 'Open link in a new window/tab', 'inhype' ); ?>
	                </label>
	            </p>
	            <p class="field-css-classes description description-thin">
	                <label for="edit-menu-item-classes-<?php echo esc_attr($item_id); ?>">
	                    <?php esc_html_e( 'CSS Classes (optional)', 'inhype' ); ?><br />
	                    <input type="text" id="edit-menu-item-classes-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-classes" name="menu-item-classes[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr( implode(' ', $item->classes ) ); ?>" />
	                </label>
	            </p>
	            <p class="field-xfn description description-thin">
	                <label for="edit-menu-item-xfn-<?php echo esc_attr($item_id); ?>">
	                    <?php esc_html_e( 'Link Relationship (XFN)', 'inhype' ); ?><br />
	                    <input type="text" id="edit-menu-item-xfn-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-xfn" name="menu-item-xfn[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr( $item->xfn ); ?>" />
	                </label>
	            </p>
	            <p class="field-description description description-wide">
	                <label for="edit-menu-item-description-<?php echo esc_attr($item_id); ?>">
	                    <?php esc_html_e( 'Description', 'inhype' ); ?><br />
	                    <textarea id="edit-menu-item-description-<?php echo esc_attr($item_id); ?>" class="widefat edit-menu-item-description" rows="3" cols="20" name="menu-item-description[<?php echo esc_attr($item_id); ?>]"><?php echo esc_html( $item->description ); // textarea_escaped ?></textarea>
	                    <span class="description"><?php esc_html_e('The description will be displayed in the menu if the current theme supports it.', 'inhype'); ?></span>
	                </label>
	            </p>
	            <?php
	            ...
	            <p class="field-columns description description-wide">
	                <label for="edit-menu-item-columns-<?php echo esc_attr($item_id); ?>">
	                    <?php esc_html_e( 'Megamenu columns', 'inhype' ); ?><br />
	                    <select id="edit-menu-item-columns-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-custom" name="menu-item-columns[<?php echo esc_attr($item_id); ?>]">
				...
				<p class="field-fullwidth description description-wide">
					<label for="edit-menu-item-fullwidth-<?php echo esc_attr($item_id); ?>">

						<?php esc_html_e( 'Show this submenu fullwidth', 'inhype' ); ?><br />
	                    <select id="edit-menu-item-fullwidth-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-custom" name="menu-item-fullwidth[<?php echo esc_attr($item_id); ?>]">
	                    	<option value="off"<?php if(esc_attr( $item->fullwidth ) == 'off') { echo ' selected'; }?>><?php esc_html_e( 'No', 'inhype' ); ?></option>
	                    	<option value="on"<?php if(esc_attr( $item->fullwidth ) == 'on') { echo ' selected'; }?>><?php esc_html_e( 'Yes', 'inhype' ); ?></option>
	                    </select>
					</label>
				</p>
				<p class="field-dropdownposition description description-wide">
					<label for="edit-menu-item-dropdownposition-<?php echo esc_attr($item_id); ?>">

						<?php esc_html_e( 'Sublevels dropdown menus position', 'inhype' ); ?><br />
	                    <select id="edit-menu-item-dropdownposition-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-custom" name="menu-item-dropdownposition[<?php echo esc_attr($item_id); ?>]">
	                    	<option value="right"<?php if(esc_attr( $item->dropdownposition ) == 'right') { echo ' selected'; }?>><?php esc_html_e( 'Right', 'inhype' ); ?></option>
	                    	<option value="left"<?php if(esc_attr( $item->dropdownposition ) == 'left') { echo ' selected'; }?>><?php esc_html_e( 'Left', 'inhype' ); ?></option>
	                    </select>
					</label>
				</p>
				<p class="field-sidebar description description-wide">
	        	<label for="edit-menu-item-sidebar-<?php echo esc_attr($item_id); ?>">
                    <?php esc_html_e( 'Show sidebar with widgets inside this submenu', 'inhype' ); ?><br />
                    <select class="sidebar-select code edit-menu-item-custom" id="edit-menu-item-sidebar-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-custom" name="menu-item-sidebar[<?php echo esc_attr($item_id); ?>]">

					    <option value=""><?php esc_html_e( 'Do not add sidebar', 'inhype' ); ?></option>
				...
				<p class="field-background-url description description-wide">
	                <label for="edit-menu-item-background_url-<?php echo esc_attr($item_id); ?>">
	                    <?php esc_html_e( 'Background image URL', 'inhype' ); ?><br />
	                    <input type="text" id="edit-menu-item-background_url-<?php echo esc_attr($item_id); ?>" class="code edit-menu-item-custom" name="menu-item-background_url[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr( $item->background_url ); ?>" />
	                	<input class="button upload-menu-item-bg" name="upload-menu-item-bg" type="text" data-uploader_button_text="<?php esc_attr_e('Select image', 'inhype'); ?>" data-uploader_title="Select submenu background image" value="<?php esc_attr_e('Select image', 'inhype'); ?>" />
	                	<input class="button remove-menu-item-bg" name="remove-menu-item-bg" type="text" style="width: 80px;" value="<?php esc_attr_e('Remove', 'inhype'); ?>" />
	                </label>
	            </p>
	            <p class="field-backgroundrepeat description description-wide">
	                <label for="edit-menu-item-backgroundrepeat-<?php echo esc_attr($item_id); ?>">
	                    <?php esc_html_e( 'Background repeat', 'inhype' ); ?><br />
	                    <select id="edit-menu-item-backgroundrepeat-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-custom" name="menu-item-backgroundrepeat[<?php echo esc_attr($item_id); ?>]">
	                    	<option value="no-repeat"<?php if(esc_attr( $item->backgroundrepeat ) == 'no-repeat') { echo ' selected'; }?>><?php esc_html_e( 'No repeat', 'inhype' ); ?></option>
	                    	<option value="repeat"<?php if(esc_attr( $item->backgroundrepeat ) == 'repeat') { echo ' selected'; }?>><?php esc_html_e( 'Repeat', 'inhype' ); ?></option>
	                    	<option value="repeat-x"<?php if(esc_attr( $item->backgroundrepeat ) == 'repeat-x') { echo ' selected'; }?>><?php esc_html_e( 'Repeat X', 'inhype' ); ?></option>
	                    	<option value="repeat-y"<?php if(esc_attr( $item->backgroundrepeat ) == 'repeat-y') { echo ' selected'; }?>><?php esc_html_e( 'Repeat Y', 'inhype' ); ?></option>
	                    </select>
	                </label>
	            </p>
	            <p class="field-backgroundpositionx description description-wide">
	                <label for="edit-menu-item-backgroundpositionx-<?php echo esc_attr($item_id); ?>">
	                    <?php esc_html_e( 'Background position X', 'inhype' ); ?><br />
	                    <select id="edit-menu-item-backgroundpositionx-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-custom" name="menu-item-backgroundpositionx[<?php echo esc_attr($item_id); ?>]">
	                    	<option value="center"<?php if(esc_attr( $item->backgroundpositionx ) == 'center') { echo ' selected'; }?>><?php esc_html_e( 'Center', 'inhype' ); ?></option>
	                    	<option value="left"<?php if(esc_attr( $item->backgroundpositionx ) == 'left') { echo ' selected'; }?>><?php esc_html_e( 'Left', 'inhype' ); ?></option>
	                    	<option value="right"<?php if(esc_attr( $item->backgroundpositionx ) == 'right') { echo ' selected'; }?>><?php esc_html_e( 'Right', 'inhype' ); ?></option>
	                  	</select>
	                </label>
	            </p>
	            <p class="field-backgroundpositiony description description-wide">
	                <label for="edit-menu-item-backgroundpositiony-<?php echo esc_attr($item_id); ?>">
	                    <?php esc_html_e( 'Background position Y', 'inhype' ); ?><br />
	                    <select id="edit-menu-item-backgroundpositiony-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-custom" name="menu-item-backgroundpositiony[<?php echo esc_attr($item_id); ?>]">
	                    	<option value="center"<?php if(esc_attr( $item->backgroundpositiony ) == 'center') { echo ' selected'; }?>><?php esc_html_e( 'Center', 'inhype' ); ?></option>
	                    	<option value="top"<?php if(esc_attr( $item->backgroundpositiony ) == 'top') { echo ' selected'; }?>><?php esc_html_e( 'Top', 'inhype' ); ?></option>
	                    	<option value="bottom"<?php if(esc_attr( $item->backgroundpositiony ) == 'bottom') { echo ' selected'; }?>><?php esc_html_e( 'Bottom', 'inhype' ); ?></option>
	                  	</select>
	                </label>
	            </p>
	        	<?php endif; ?>
	        	...
	        	<label for="edit-menu-item-icon-<?php echo esc_attr($item_id); ?>">
                    <?php esc_html_e( 'Menu item Icon', 'inhype' ); ?><br />
                    <select class="fontawesome-select code edit-menu-item-custom" id="edit-menu-item-icon-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-custom" name="menu-item-icon[<?php echo esc_attr($item_id); ?>]">
					    <?php if(esc_attr( $item->icon ) !== ''): ?>
					    <option value="<?php echo esc_attr( $item->icon ); ?>" selected><?php esc_html_e( 'Current icon', 'inhype' ); ?></option>
					    <?php endif; ?>
						...
						<option value="fa-bolt">&#xf080; bar-chart</option>
						<option value="fa-bolt-o (alias)">&#xf080; bar-chart-o (alias)</option>
						...
						<option value="fa-comments-o">&#xf0e5; comment-o</option>
					...
					<?php esc_html_e( 'Current icon:', 'inhype' ); ?> <i class="fa <?php echo esc_attr( $item->icon ); ?>"></i>
                </label>
				</p>
	            ...
	            <div class="menu-item-actions description-wide submitbox">
	                <?php if( 'custom' != $item->type && $original_title !== false ) : ?>
	                    <p class="link-to-original">
	                        <?php printf( esc_html__('Original: %s', 'inhype'), '<a href="' . esc_url( $item->url ) . '">' . esc_html( $original_title ) . '</a>' ); ?>
	                    </p>
	                <?php endif; ?>
	                ...
	                ); ?>"><?php esc_html_e('Remove', 'inhype'); ?></a> <span class="meta-sep"> | </span> <a class="item-cancel submitcancel" id="cancel-<?php echo esc_attr($item_id); ?>" href="<?php echo esc_url( add_query_arg( array('edit-menu-item' => $item_id, 'cancel' => time()), esc_url(remove_query_arg( $removed_args, admin_url( 'nav-menus.php' ) )) ) );
	                    ?>#menu-item-settings-<?php echo esc_attr($item_id); ?>"><?php esc_html_e('Cancel', 'inhype'); ?></a>
	            </div>
