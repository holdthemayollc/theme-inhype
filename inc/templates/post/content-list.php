...
echo '<div class="inhype-list-post inhype-post'.esc_attr($post_class).'"'.inhype_add_aos(false).'>';
...
?>
<div class="post-readmore"><a href="<?php the_permalink(); ?>" class="more-link btn"><?php esc_html_e('Read more', 'inhype'); ?></a>
</div>
