...
echo '<div class="inhype-grid-post inhype-grid-large-post inhype-post'.esc_attr($post_class).'"'.inhype_add_aos(false).'>';
...
if(get_the_excerpt() !== get_the_content()):
    ...
    <div class="post-readmore">
        <a href="<?php the_permalink(); ?>" class="more-link btn"><?php esc_html_e('Read more', 'inhype'); ?></a>
    </div>
    <?php
endif;
?>
